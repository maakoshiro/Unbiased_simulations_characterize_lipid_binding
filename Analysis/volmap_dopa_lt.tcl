mol delete all
mol new dopa_v.gro
mol addfile traj_dopa_v.xtc waitfor all
...
volmap density [atomselect top "resname DOPA and not name PO4 NC3"] -res 0.5 -allframes -combine avg -mol top -o volmap_density_all_dopa_lt.dx
$frame0 writepdb prot_dopa_frame0_lt.pdb
exit
