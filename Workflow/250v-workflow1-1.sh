...
do
	...
	#Solvating with non-polarizable water
        #gmx solvate -cp 1molecule_${lipid}_seed${replica}.gro -cs ~/protein/common/water.gro -radius 0.21 -o solv_1molecule_${lipid}_seed${replica}.gro
        ...
        #gmx grompp -f ~/protein/common/ions-cg.mdp -c solv_1molecule_${lipid}_seed${replica}.gro -p ${lipid}_seed${replica}.top -o ions_${lipid}_seed${replica}.tpr  -maxwarn 1
