...
martinize2 -f 250v-step1_pdbreader.pdb -x ${pdb}_cg_fc1000_eu8.pdb -o topol.top -ff martini3001 -elastic -ef 1000 -eu 0.8 -nt -scfix -cys auto -dssp /usr/anaconda3/envs/py39/dssp 
